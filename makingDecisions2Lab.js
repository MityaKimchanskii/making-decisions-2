...
console.log("Problem 2 last item: ",lastItemRemoved)
arr.splice(-1)
console.log("Problem 2 arr: ",arr)
...
for( let i = 0; i <= family.length -1; i++){
  console.log("Problem 3: ",family[i])
}
...
// Do not edit the code below.
var myFavoriteNumbers = [4,8,12,16,20,24]//,1,1,1,1,1];
// Do not edit the code above.
...
// subscript to the 7th element, but there are not 7 elements in the array? Let's write some code to check for that. 
// Use an if statement to check the length of the 'myFavoriteNumbers' array. If it's less than 7, log 'There are not 
// enough elements in this array' to the console. If the length is more than 7, reassign the value of 'someNum' to the 
// value of the 7th element in the array. (Hint: how can you make sure that your code works for exactly 7 elements? What 
...
console.log("Problem 7: Lenght array =",myFavoriteNumbers.length)
console.log("Problem 7: ",myFavoriteNumbers)
...
for (let i = letters.length - 1; i >= 0; i--){
  console.log("Problem 9:", letters[i])
}
...
////////// PROBLEM 10 ////////////////////////////////////////////////////////////////////////////////////////////////
// Switch statements can be excellent alternatives to if blocks. Look up switch statements (I recommend W3 Schools) 
// and try to implement one for the following.
...
switch(letterGrade){
  ...
  case ("A") : console.log("Problem 10: The student is doing excellently.");
    break;
  case ("B") : console.log("Problem 10: The student is doing well.");
    break;
  case ("C") : console.log("Problem 10: The student is doing alright.");
    break;
  case ("D") : console.log("Problem 10: The student is not doing very well."); 
    break;
  case ("F") : console("Problem 10: The student is failing.");
    break;
  default: console.log("Problem 10: Not an eligible grade.")
}
...
for (let i = 1; i <= 100; i++ ){
  if (i % 3 === 0 && i % 5 === 0){
    console.log("Problem 11: DevMountain")
  } else if (i % 5 === 0){
    console.log("Problem 11: Mountain")
  } else if(i % 3 === 0){
    console.log("Problem 11: Dev")
  } else {
    console.log("Problem 11:",i)
  }
}
///////////////////////////////   END   //////////////////////////////////////////////////////////////////////////////////////////
